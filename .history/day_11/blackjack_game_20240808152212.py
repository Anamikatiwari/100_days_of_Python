...
# If the game has  not ended, ask the user if they want to draw another card. If yes, the use the deal_card() function to add another card to the user_card list
