...
# call calculate_score(). If the computer or user has a blackjack (0) or if the user's score is over 21, then the game ends.add()

# If the game has  not ended, ask the user if they want to draw another card. If yes, the use the deal_card() function to add another card to the user_card list. If no, then the 
