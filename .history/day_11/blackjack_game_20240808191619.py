...
# Create a function called compare() and pass in the user_score and computer_score. If the computer and user both have the same score, then it's a draw. If computer has ablackjack (0), then the user losses. If the user has a blackjac (0) , then the user wins. If the user_score is over 21, then the user losses. If the computer_score is over 21, then computer 
