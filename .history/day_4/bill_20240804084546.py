...
"""person_who_will_pay = random.choice(names) # random.choice(seq), is a widely used function in practice, wherein you would want to randomly pick up an item from a list/sequence
print(person_who_will_pay + "is going to buy the meal today!") """